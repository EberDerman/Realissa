<div class="container mt-5">
    <div class="row">
        ...
        <div class="col-md-5 mb-4 textoComponentes">
            ...
            <p>El condado cuenta con casi 120.000 habitantes y es una localidad de clase media,
        ...
        <div class="col-md-5 mb-4 textoComponentes">
            ...
            <ul class="list-unstyled">
                <li><strong>CRECIMIENTO SOSTENIDO</strong></li>
                ...
                <li><strong>IMPULSO REGIONAL</strong></li>
                <p>Está a sólo 25 minutos de Ft. Myers, la ciudad
                ...
                <li><strong>DESARROLLO DE INFRAESTRUCTURA</strong></li>
                ...
                <li><strong>TIERRA A LA VISTA</strong></li>
