...
<div class="container mt-5">
    <div class="col-md-7 mb-4 textoComponentes">
        <h2 class="mb-4"> POTENCIAMOS TU PATRIMONIO</h2>
        <h4>Tipos de terrenos</h4>
        <P> En Cape Coral se pueden encontrar <span class="numero">3</span> tipos de lotes: Secos. Sin acceso a canales. Con canales internos navegables. Con acceso a canales externos y salida directa al mar. Todos los lotes en Cape Coral son planos, lo que facilita la posterior construcción.</P>
        ...
        <ul class="list-unstyled">
            <li>Procesos de calidad y actores expertos en la construcción.</li>
